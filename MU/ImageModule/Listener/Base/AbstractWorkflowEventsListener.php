...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        if (!$this->permissionApi->hasPermission('MUImageModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
        ...
        if ($transitionName == 'delete') {
            ...
            if ($objectType == 'album') {
                $isBlocked = false;
                if (count($entity->getAlbums()) > 0) {
                    $isBlocked = true;
                }
                if (count($entity->getPictures()) > 0) {
                    $isBlocked = true;
                }
