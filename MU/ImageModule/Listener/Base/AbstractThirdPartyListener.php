...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(EditorHelperEvent $event)
    {
        ...
        $event->getHelperCollection()->add(
            [
                ...
                'type' => 'javascript',
                'path' => $this->request->getBasePath() . '/web/modules/muimage/js/MUImageModule.Finder.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'muimagemodule',
            'path' => $this->request->getBasePath() . '/web/modules/muimage/scribite/CKEditor/muimagemodule/',
            'file' => 'plugin.js',
    ...
    public function getQuillPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'muimagemodule',
            'path' => $this->request->getBasePath() . '/web/modules/muimage/scribite/Quill/muimagemodule/plugin.js'
        ]);
    }
    ...
    public function getSummernotePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'muimagemodule',
            'path' => $this->request->getBasePath() . '/web/modules/muimage/scribite/Summernote/muimagemodule/plugin.js'
        ]);
    }
    ...
    public function getTinyMcePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'muimagemodule',
            'path' => $this->request->getBasePath() . '/web/modules/muimage/scribite/TinyMce/muimagemodule/plugin.js'
        ]);
    }
}
