...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from image app';
     *     $event->getRequest()->attributes->set('MUImageModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUImageModule_test');`
     *     now `$testMessage` should be: `'Hello from image app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('image App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
