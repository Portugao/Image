        ...
        if ($contextName == $this->name . '_relateditem') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('MUImageModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('MUImageModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
