...
abstract class AbstractCollectionFilterHelper
{
    ...
    protected function getViewQuickNavParametersForAlbum($context = '', array $args = [])
    {
        ...
        $parameters['album'] = $request->query->get('album', 0);
        $parameters['workflowState'] = $request->query->get('workflowState', '');
        $parameters['albumAccess'] = $request->query->get('albumAccess', '');
        $parameters['q'] = $request->query->get('q', '');
        $parameters['notInFrontend'] = $request->query->get('notInFrontend', '');
    ...
    protected function getViewQuickNavParametersForPicture($context = '', array $args = [])
    {
        ...
        $parameters['workflowState'] = $request->query->get('workflowState', '');
        $parameters['q'] = $request->query->get('q', '');
        $parameters['albumImage'] = $request->query->get('albumImage', '');
    ...
    protected function getViewQuickNavParametersForAvatar($context = '', array $args = [])
    {
        ...
        $parameters['workflowState'] = $request->query->get('workflowState', '');
        $parameters['supportedModules'] = $request->query->get('supportedModules', '');
        $parameters['q'] = $request->query->get('q', '');
    ...
    public function addSearchFilter($objectType, QueryBuilder $qb, $fragment = '')
    {
        ...
        if ($objectType == 'picture') {
            ...
            $filters[] = 'tbl.description LIKE :searchDescription';
            $parameters['searchDescription'] = '%' . $fragment . '%';
            $filters[] = 'tbl.imageUploadFileName = :searchImageUpload';
        ...
        if ($objectType == 'avatar') {
            ...
            $filters[] = 'tbl.description LIKE :searchDescription';
            $parameters['searchDescription'] = '%' . $fragment . '%';
            $filters[] = 'tbl.avatarUploadFileName = :searchAvatarUpload';
