...
abstract class AbstractPermissionHelper implements ContainerAwareInterface
{
    ...
    public function hasEntityPermission($entity, $permissionLevel, $userId = null)
    {
        ...
        return $this->permissionApi->hasPermission('MUImageModule:' . ucfirst($objectType) . ':', $instance, $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUImageModule:' . ucfirst($objectType) . ':', '::', $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUImageModule::', '::', $permissionLevel, $userId);
    }
