...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func)
    {
        ...
        $template = '@MUImageModule/' . ucfirst($type) . '/' . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('MUImageModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = ['rss'];
            } else {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@MUImageModule/includePdfHeader.html.twig') . $output . '</body></html>';
