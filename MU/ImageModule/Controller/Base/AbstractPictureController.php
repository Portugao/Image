...
abstract class AbstractPictureController extends AbstractController
{
    ...
    {
        $picture = $this->get('mu_image_module.entity_factory')->getRepository('picture')->selectById($id);
        if (null === $picture) {
            throw new NotFoundHttpException($this->__('No such picture found.'));
        }
    ...
    protected function displayInternal(Request $request, PictureEntity $picture, $isAdmin = false)
    {
        ...
        $controllerHelper = $this->get('mu_image_module.controller_helper');
        $templateParameters = $controllerHelper->processDisplayActionParameters($objectType, $templateParameters, $picture->supportsHookSubscribers());
     ...
     *
     * @throws AccessDeniedException Thrown if the user doesn't have required permissions
     * @throws NotFoundHttpException Thrown if picture to be deleted isn't found
     * @throws RuntimeException      Thrown if another critical error occurs (e.g. workflow actions not available)
     */
    ...
    protected function deleteInternal(Request $request, $id, $isAdmin = false)
    {
        ...
        $form = $this->createForm(DeletionType::class, $picture);
