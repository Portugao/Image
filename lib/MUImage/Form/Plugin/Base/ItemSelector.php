 ...
 */
class MUImage_Form_Plugin_Base_ItemSelector extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if (!SecurityUtil::checkPermission('MUImage:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        if (in_array($this->objectType, $categorisableObjectTypes)) {
            ...
            $catIds = ModUtil::apiFunc('MUImage', 'category', 'retrieveCategoriesFromRequest', array('ot' => $this->objectType));
        }
        ...
        $properties = null;
        if (in_array($this->objectType, $categorisableObjectTypes)) {
            $properties = ModUtil::apiFunc('MUImage', 'category', 'getAllProperties', array('ot' => $this->objectType));
        }
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('MUImage_objecttype', 'album', 'POST');
        $this->selectedItemId = $this->text;
    }
}
