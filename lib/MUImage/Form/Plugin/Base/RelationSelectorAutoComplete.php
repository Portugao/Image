 ...
 */
     ...
     */
    class MUImage_Form_Plugin_Base_RelationSelectorAutoComplete extends MUImage_Form_Plugin_AbstractObjectSelector
    {
        /**
        ...
        public function render(Zikula_Form_View $view)
        {
            ...
            switch ($this->objectType) {
                case 'album':
                    ...
                    break;
                case 'picture':
                    $entityNameTranslated = __('picture', $dom);
                    break;
            }
            ...
            $createLink = '';
            if ($this->createLink != '') {
                $createLink = '<a id="' . $idPrefix . 'SelectorDoNew" href="' . DataUtil::formatForDisplay($this->createLink) . '" title="' . __f('Create new %s', array($entityNameTranslated), $dom) . '" class="z-button muimage-inline-button">' . __('Create', $dom) . '</a>';
            }
            ...
            $result = '
                <div class="muimage-relation-rightside">'
                    . $addLink . '
                    <div id="' . $idPrefix . 'AddFields muimage-autocomplete' . (($this->withImage) ? '-with-image' : '') . '">
            ...
            $result .= '
                            <input type="button" id="' . $idPrefix . 'SelectorDoCancel" name="' . $idPrefix . 'SelectorDoCancel" value="' . __('Cancel', $dom) . '" class="z-button muimage-inline-button" />'
                            . $createLink . '
