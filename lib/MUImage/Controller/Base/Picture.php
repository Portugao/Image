 ...
 */
class MUImage_Controller_Base_Picture extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main()
    {
        ...
        $objectType = 'picture';
        $utilArgs = array('controller' => 'picture', 'action' => 'main');
        ...
        // set caching id
        $this->view->setCacheId('picture_main');
        
        // return main template
        return $this->view->fetch('picture/main.tpl');
    }
    ...
    public function edit()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'picture';
        $utilArgs = array('controller' => 'picture', 'action' => 'edit');
        ...
        $handlerClass = $this->name . '_Form_Handler_Picture_Edit';
    ...
    public function zipUpload()
    {
        ...
        // return template
        return $this->view->fetch('picture/zipUpload.tpl');
    }
    ...
    public function multiUpload()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'picture';
        $utilArgs = array('controller' => 'picture', 'action' => 'multiUpload');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
        
        // return template
        return $this->view->fetch('picture/multiUpload.tpl');
    }
    ...
    public function external()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'picture';
        $utilArgs = array('controller' => 'picture', 'action' => 'external');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
        
        // return template
        return $this->view->fetch('picture/external.tpl');
    }
    ...
    public function editMulti()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'picture';
        $utilArgs = array('controller' => 'picture', 'action' => 'editMulti');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
        
        // return template
        return $this->view->fetch('picture/editMulti.tpl');
    }
    ...
    public function handleSelectedEntries()
    {
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'picture'));
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'picture', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
    ...
    public function handleInlineRedirect()
    {
        ...
        $this->view->display('picture/inlineRedirectHandler.tpl');
