 ...
 */
class MUImage_Listener_ModuleDispatch extends MUImage_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('MUImage', 'user', 'main'), 'text' => __('Link Text'));
