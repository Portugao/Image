 ...
 */
class MUImage_Listener_Base_ThirdParty
{
    /**
    ...
    public static function getEditorHelpers(Zikula_Event $event)
    {
        ...
        $helpers->add(
            array('module' => 'MUImage',
                  'type'   => 'javascript',
                  'path'   => 'modules/MUImage/javascript/MUImage_finder.js')
        );
    }
    ...
    public static function getTinyMcePlugins(Zikula_Event $event)
    {
        ...
        $plugins->add(
            array('name' => 'muimage',
                  'path' => 'modules/MUImage/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/muimage/editor_plugin.js'
            )
        );
    }
    ...
    public static function getCKEditorPlugins(Zikula_Event $event)
    {
        ...
        $plugins->add(
            array('name' => 'muimage',
                  'path' => 'modules/MUImage/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/muimage/',
                  'file' => 'plugin.js',
                  'img'  => 'ed_muimage.gif'
            )
        );
