 ...
 */
class MUImage_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    protected static function processPdf(Zikula_View $view, $template)
    {
        ...
        $fileTitle = MUImage_Util_Controller::formatPermalink(System::getVar('sitename'))
            . '-'
            . MUImage_Util_Controller::formatPermalink(PageUtil::getVar('title'))
            . '-' . date('Ymd') . '.pdf';
