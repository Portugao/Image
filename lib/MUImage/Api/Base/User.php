 ...
 */
class MUImage_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getLinks()
    {
        ...
        if (in_array('picture', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Picture:', '::', ACCESS_READ)) {
    ...
    public function decodeurl(array $args = array())
    {
        ...
        $funcs = array('main', 'view', 'display', 'edit', 'delete', 'zipUpload', 'multiUpload', 'external', 'editMulti');
