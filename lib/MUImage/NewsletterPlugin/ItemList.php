 ...
 */
class MUImage_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest MUImage items');
    }
    ...
    {
        return $this->__('List of albums and other MUImage items');
    }
    ...
    {
        return $this->__('This plugin shows a list of albums and other items of the MUImage module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            ...
            $objectTypes['picture'] = array('name' => $this->__('Pictures'));
        }
