...
<div class="z-admin-content-pagetitle">
    ...
    <p class="z-warningmsg">{gt text='Attention! For a complete import of all albums with the correct structure of main albums and subalbums it is important, that you import them in order of the dropdownlist below!'}</p>
