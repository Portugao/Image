...
/**
 * Smarty function to wrap MUIamge_Form_View generated form controls with suitable form tags.
 *
 ...
 */
function smarty_block_muimageform($params, $content, $view)
{
	if ($content) {
		...
		if(strpos($action,"func=editMulti")!==false) {
