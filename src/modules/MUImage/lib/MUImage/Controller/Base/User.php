...
class MUImage_Controller_Base_User extends Zikula_AbstractController
{
    ...
    public function display($args)
    {
        ...
        // fetch and return the appropriate template
        return MUImage_Util_View::processTemplate($this->view, 'user', $objectType, 'display', $args);
    }
    ...
    {
        // DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUImage::', '::', ACCESS_DELETE));
        // DEBUG: permission check aspect ends
