...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='mUMUImageModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
            {mumuimagemoduleObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='mUMUImageModuleObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes cssClass='form-control'}
    ...
    <div{* class="form-group"*}>
        ...
        {mumuimagemoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
