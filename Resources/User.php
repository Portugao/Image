    ...
    public static function loader($args)
    {
        ...
        if (ModUtil::apiFunc('Scribite', 'user', 'getEditors', array('editorname' => $args['editor']))) {
            ...
            if (ModUtil::available('MUImage')) {
                PageUtil::AddVar('javascript', 'modules/MUImage/javascript/MUImage_finder.js');
                PageUtil::AddVar('stylesheet', 'http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css');
            }
