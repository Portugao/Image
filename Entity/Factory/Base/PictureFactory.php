...
namespace MU\MUImageModule\Entity\Factory\Base;
 ...
 *
 * This is the base factory class for picture entities.
 */
class PictureFactory
{
    /**
     * @var String Full qualified class name to be used for pictures.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for pictures.
     */
