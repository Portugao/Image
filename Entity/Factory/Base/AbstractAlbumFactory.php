 ...
 *
 * This is the base factory class for album entities.
 */
abstract class AbstractAlbumFactory
{
    /**
     * @var String Full qualified class name to be used for albums.
     */
    protected $className;
    ...
    /**
     * AlbumFactory constructor.
     *
     * @param ObjectManager $objectManager The object manager to be used for determining the repository
     * @param String        $className     Full qualified class name to be used for albums
     */
