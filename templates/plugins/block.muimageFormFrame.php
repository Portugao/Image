...
/**
 * The muimageFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_muimageFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MUImage_Form_Plugin_FormFrame', $params, $content);
