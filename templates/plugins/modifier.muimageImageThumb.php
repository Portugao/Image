 ...
 */
function smarty_modifier_muimageImageThumb($fileName = '', $filePath = '', $width = 100, $height = 80, $thumbArgs = array())
{
    /**
     ...
     */
    return MUImage_Util_Image::getThumb($filePath, $width, $height, $thumbArgs);
}
