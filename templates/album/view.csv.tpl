...
{strip}"{gt text='Title'}";"{gt text='Description'}";"{gt text='Parent_id'}";"{gt text='Album access'}";"{gt text='My friends'}";"{gt text='Password access'}";"{gt text='Not in frontend'}";"{gt text='Workflow state'}"
;"{gt text='Parent'}"
