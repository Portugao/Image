...
{foreach item='album' from=$items}
    <item>
        ...
        <link>{modurl modname='MUImage' type=$lct func='display' ot='album'  id=$album.id fqurl=true}</link>
        <guid>{modurl modname='MUImage' type=$lct func='display' ot='album'  id=$album.id fqurl=true}</guid>
