...
<div class="muimage-album muimage-delete">
    ...
    <form class="z-form" action="{modurl modname='MUImage' type=$lct func='delete' ot='album'  id=$album.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='MUImage' type=$lct func='view' ot='album'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
