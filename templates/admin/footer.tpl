...
<p class="z-center">
    Powered by <a href="http://modulestudio.de" title="Get the MOST out of Zikula!">ModuleStudio 0.5.4</a> and <a href="http://www.webdesign-in-bremen.com" title="Get Zikula in use with MU(t) Beratung Internet">MU(t) Beratung Intrnet</a>
</p>
{adminfooter}
