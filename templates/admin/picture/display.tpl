{* purpose of this template: pictures display view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    <h3>{$templateTitle|notifyfilters:'muimage.filter_hooks.pictures.filter'}</h3>
</div>
  ...
  {/if}
    ...
    {if isset($picture.Album) && $picture.Album ne null}
      {if !isset($smarty.get.theme) || $smarty.get.theme ne 'Printer'}
        ...
        <a id="albumItem{$picture.Album.id}Display" href="{modurl modname='MUImage' type='admin' func='display' ot='album' id=$picture.Album.id theme='Printer'}" title="{gt text='Open quick view window'}" style="display: none">
    ...
    {include file='admin/include_standardfields_display.tpl' obj=$picture}
