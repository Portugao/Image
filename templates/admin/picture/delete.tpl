{* purpose of this template: pictures delete confirmation view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    <form class="z-form" action="{modurl modname='MUImage' type='admin' func='delete' ot='picture' id=$picture.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='MUImage' type='admin' func='view' ot='picture'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
