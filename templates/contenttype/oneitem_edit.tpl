...
{* <div class="z-formrow">
 ...
 <div class="z-formrow">
    ...
    {muimageSelectorPictures assign='Pictures'}
    {formdropdownlist id='MUImage_picture' dataField='picture' group='data' mandatory=true items=$Pictures}
</div> 
<div class="z-formrow">
    {formlabel for='MUImage_id' __text='Id'}
    {formtextinput id='MUImage_id' dataField='id' group='data' mandatory=false maxLength=20}
</div>
<div class="z-formrow">
