...
class WorkflowHelper
{
    ...
    public function getActionsForObject($entity)
    {
        ...
        $listHelper = $this->container->get('mu_muimage_module.listentries_helper');
    ...
    public function executeAction($entity, $actionId = '', $recursive = false)
    {
        ...
        $result = Zikula_Workflow_Util::executeAction($schemaName, $entity, $actionId, $objectType, 'MUMUImageModule', $idColumn);
    ...
    public function normaliseWorkflowData(&$entity)
    {
        ...
        if (!is_object($workflow)) {
            $workflow['module'] = 'MUMUImageModule';
    ...
    {
        $repository = $this->container->get('mu_muimage_module.' . $objectType . '_factory')->getRepository();
