...
class AjaxController extends AbstractController
{
    ...
    public function getItemListAutoCompletionAction(Request $request)
    {
        ...
        if ((is_array($entities) || is_object($entities)) && count($entities) > 0) {
            ...
            //$imageHelper = $this->get('mu_muimage_module.image_helper');
    ...
    public function checkForDuplicateAction(Request $request)
    {
         ...
         * $object = $this->get('muimage.' . $objectType . '_factory')->$createMethod();
         */
    ...
    public function toggleFlagAction(Request $request)
    {
        ...
        if ($id == 0
            || ($objectType != 'picture')
        || ($objectType == 'picture' && !in_array($field, ['showTitle', 'showDescription']))
        ) {
            return new BadDataResponse($this->__('Error: invalid input.'));
        }
        ...
        $logArgs = ['app' => 'MUMUImageModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'field' => $field, 'entity' => $objectType, 'id' => $id];
