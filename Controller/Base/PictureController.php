...
class PictureController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        if ($isAdmin) {
            ...
            return $this->redirectToRoute('mumuimagemodule_picture_' . ($isAdmin ? 'admin' : '') . 'view');
        }
        ...
        return $this->render('@MUMUImageModule/Picture/index.html.twig', $templateParameters);
    }
    /**
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        $sortableColumns = new SortableColumns($this->get('router'), 'mumuimagemodule_picture_' . ($isAdmin ? 'admin' : '') . 'view', 'sort', 'sortdir');
        $sortableColumns->addColumns([
            new Column('title'),
            new Column('description'),
            new Column('showTitle'),
            new Column('showDescription'),
            new Column('imageUpload'),
            new Column('imageView'),
        ...
        $currentUrlObject = new ModUrl($this->name, 'picture', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
     ...
     * @Theme("admin")
     * @ParamConverter("picture", class="MUMUImageModule:PictureEntity", options={"id" = "id", "repository_method" = "selectById"})
    ...
    protected function displayInternal(Request $request, PictureEntity $picture, $isAdmin = false)
    {
        ...
        $currentUrlObject = new ModUrl($this->name, 'picture', 'display', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        ...
        $formHandler = $this->get('mu_muimage_module.form.handler.picture');
    ...
    protected function deleteInternal(Request $request, PictureEntity $picture, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'MUMUImageModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'picture', 'id' => $entity->createCompositeIdentifier()];
        ...
        if ($isAdmin) {
            ...
            $redirectRoute = 'mumuimagemodule_picture_' . ($isAdmin ? 'admin' : '') . 'view';
        } else {
            // redirect to the list of pictures
            $redirectRoute = 'mumuimagemodule_picture_' . ($isAdmin ? 'admin' : '') . 'view';
        }
        ...
        if (!$deleteAllowed) {
            $flashBag->add(\Zikula_Session::MESSAGE_ERROR, $this->__('Error! It is not allowed to delete this picture.'));
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemid) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'MUMUImageModule', 'user' => $userName, 'action' => $action, 'entity' => 'picture', 'id' => $itemid, 'errorMessage' => $e->getMessage()]);
            }
            ...
            if ($action == 'delete') {
                $flashBag->add(\Zikula_Session::MESSAGE_STATUS, $this->__('Done! Item deleted.'));
                $logger->notice('{app}: User {user} deleted the {entity} with id {id}.', ['app' => 'MUMUImageModule', 'user' => $userName, 'entity' => 'picture', 'id' => $itemid]);
            } else {
                $flashBag->add(\Zikula_Session::MESSAGE_STATUS, $this->__('Done! Item updated.'));
                $logger->notice('{app}: User {user} executed the {action} workflow action for the {entity} with id {id}.', ['app' => 'MUMUImageModule', 'user' => $userName, 'action' => $action, 'entity' => 'picture', 'id' => $itemid]);
            }
            ...
            if ($action != 'delete') {
                ...
                $url = new RouteUrl('mumuimagemodule_picture_' . /*($isAdmin ? 'admin' : '') . */'display', $urlArgs);
            }
            $hookHelper->callProcessHooks($entity, $hookType, $url);
        }
        
        return $this->redirectToRoute('mumuimagemodule_picture_' . ($isAdmin ? 'admin' : '') . 'index');
    }
}
