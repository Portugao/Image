...
use MU\MUImageModule\Entity\Factory\AlbumFactory;
...
class AlbumType extends AbstractType
{
     ...
     */
    public function __construct(TranslatorInterface $translator, AlbumFactory $entityFactory, ListEntriesHelper $listHelper)
    {
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('categories', 'Zikula\CategoriesModule\Form\Type\CategoriesType', [
            'label' => $this->__('Category', [], 'mumuimagemodule') . ':',
            'empty_data' => [],
            'attr' => [
            ...
            'entity' => 'AlbumEntity',
            'entityCategoryClass' => 'MU\MUImageModule\Entity\AlbumCategoryEntity'
        ]);
    }
    ...
    {
        $builder->add('picture', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
            'class' => 'MUMUImageModule:PictureEntity',
            'choice_label' => 'getTitleFromDisplayPattern',
            'multiple' => true,
            'expanded' => false,
            'query_builder' => function(EntityRepository $er) {
            ...
            'attr' => [
                'id' => 'picture',
                'title' => $this->__('Choose the picture')
            ]
        ]);
        $builder->add('children', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
            'class' => 'MUMUImageModule:AlbumEntity',
            'choice_label' => 'getTitleFromDisplayPattern',
            'multiple' => true,
            'expanded' => false,
            ...
            'label' => $this->__('Children'),
            'attr' => [
                'id' => 'children',
                'title' => $this->__('Choose the children')
            ]
        ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\MUImageModule\Entity\AlbumEntity',
