...
namespace MU\MUImageModule\Form\Plugin\Base;
...
class ItemSelector extends Zikula_Form_Plugin_TextInput
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', '@MUMUImageModule/Resources/public/js/MUMUImageModule.Finder.js');
        ...
        if (!$permissionHelper->hasPermission('MUMUImageModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        if (in_array($this->objectType, $categorisableObjectTypes)) {
            ...
            $catIds = ModUtil::apiFunc('MUMUImageModule', 'category', 'retrieveCategoriesFromRequest', ['ot' => $this->objectType]);
        }
        ...
        $view = Zikula_View::getInstance('MUMUImageModule', false);
        ...
        $properties = null;
        if (in_array($this->objectType, $categorisableObjectTypes)) {
            $properties = ModUtil::apiFunc('MUMUImageModule', 'category', 'getAllProperties', ['ot' => $this->objectType]);
        }
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('MUMUImageModule_objecttype', 'album', 'POST');
        $this->selectedItemId = $this->text;
    }
}
