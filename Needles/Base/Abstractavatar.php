...
function MUImageModule_needleapi_avatar_base($args)
{
    ...
    $cache[$nid] = '<a href="' . $router->generate('muimagemodule_avatars_view') . '" title="' . __('View avatars', $dom) . '">' . __('Avatars', $dom) . '</a>';
    ...
    if (null === $entity) {
        $cache[$nid] = '<em>' . __f('Avatar with id %s could not be found', [$entityId], $dom) . '</em>';
