...
function MUImageModule_needleapi_picture_base($args)
{
    ...
    $cache[$nid] = '<a href="' . $router->generate('muimagemodule_pictures_view') . '" title="' . $translator->__('View pictures') . '">' . $translator->__('Pictures') . '</a>';
    ...
    if (null === $entity) {
        $cache[$nid] = '<em>' . $translator->__f('Picture with id %s could not be found', ['%s' => $entityId]) . '</em>';
